/* CONFIG
{
  ...
  "RegData": {
    ...
    "Q2": "0xFFFFFFFFFFFFFFFFFFFFFFFF00000000"
  }
}
*/
// Test: FCMGE Vd.4S, Vn.4S, Vm.4S - compare greater than or equal
...
_start:
    ...
    // FCMGE: compare Q0 >= Q1
    // [2.0, 4.0, 6.0, 8.0] >= [4.0, 4.0, 3.0, 6.0] = [0, 1, 1, 1]
    fcmge v2.4s, v0.4s, v1.4s
